                        ...
                        <ul className="dropdown-menu dropdown-menu-end dropdown-dark-custom" aria-labelledby="navbarDropdown">
                            <li>
                                <div className="dropdown-header-info px-3 py-2 border-bottom border-secondary">
                                    ...
                                    <small className="text-muted">{auth.role?.replace("ROLE_", "")}</small>
                                </div>
                            </li>
                            <li>
                                <Link to="/settings" className="dropdown-item dropdown-item-custom">
                                    <i className="bi bi-gear me-2"></i>Settings
                                </Link>
                            </li>
                            <li>
                                <Link to="/activity" className="dropdown-item dropdown-item-custom">
                                    <i className="bi bi-clock-history me-2"></i>Activity log
                                </Link>
                            </li>
                            <li><hr className="dropdown-divider border-secondary" /></li>
                            <li>
                                <a href="#!" className="dropdown-item dropdown-item-custom text-danger" onClick={logout}>
