...
const Dashboard = () => {
    ...
    useEffect(() => {
        fetchDashboardData()
            ...
            .catch(() => toast.error("Unable to view the data"))
            ...
            <div className="dashboard-container">
                ...
                <div className="charts-row">
                    ...
                    <div className="chart-card">
                        <h5 className="chart-card-title"><i className="bi bi-pie-chart-fill me-2 text-info"></i>Payment Breakdown</h5>
                        {pieData.length > 0 ? (
                            <ResponsiveContainer width="100%" height={220}>
                                <PieChart>
                                    ...
                                    <Tooltip formatter={(v, n, p) => [`${v} orders`, n]} />
                                </PieChart>
                            </ResponsiveContainer>
                    ...
                    {/* Bar Chart */}
                    <div className="chart-card">
                        <h5 className="chart-card-title"><i className="bi bi-bar-chart-fill me-2 text-success"></i>7-Day Trend</h5>
                        {barData.length > 0 ? (
                            <ResponsiveContainer width="100%" height={220}>
